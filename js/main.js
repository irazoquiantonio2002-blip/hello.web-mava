...
(function () {
  ...
  if (marqueeInner) {
    const items = [
      'Refacciones para Montacargas', 'Patines Hidráulicos', 'Llantas Industriales',
      'Mantenimiento Preventivo', 'Mantenimiento Correctivo', 'Servicio de Torno',
      'Maquinado de Precisión', 'Refacciones Originales y Genéricas', 'Entrega Rápida',
      'Garantía por Escrito', 'Atención a Talleres y Almacenes', 'Cotización sin Costo'
    ];
